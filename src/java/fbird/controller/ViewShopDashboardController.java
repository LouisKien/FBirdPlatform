 ...
 * @author louis
 */
public class ViewShopDashboardController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UserDTO shop = (UserDTO) session.getAttribute("LOGIN_USER");
            int shop_id = shop.getShop_id();
            ProductDAO pdao = new ProductDAO();
            List<ProductDTO> listOrderItem = pdao.getListShopOrderItem(shop_id);
