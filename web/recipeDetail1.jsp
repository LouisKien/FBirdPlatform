    ...
    <body>
        ...
        <div style="position: relative">
            ...
            <div style="background-color: #BCDAE0;">
               ...
               if (listRecipeDetail != null && !listRecipeDetail.isEmpty()) {
          
                   for (Recipe recipe : listRecipeDetail) {
               
                %>
                <div class="flex-box">
                    <div class="left" style="margin-top: 100px; margin-right:40px;">
                        <div class="big-img">
                            <img src="<%= recipe.getRecipe_image1() %>">
                        </div>
                        <div class="images">
                            <div class="small-img">
                                <img src="<%= recipe.getRecipe_image1() %>" onclick="showImg(this.src)">
                            </div>
                            <div class="small-img">
                                <img src="<%= recipe.getRecipe_image2() %>" onclick="showImg(this.src)">
                            </div>
                            <div class="small-img">
                                <img src="<%= recipe.getRecipe_image3() %>" onclick="showImg(this.src)">
                            </div>
                            <div class="small-img">
                                <img src="<%= recipe.getRecipe_image4() %>" onclick="showImg(this.src)">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="right">
                        ...
                        <div class="pname" style="margin-bottom: 1px;">
                            <%= listRecipeDetail.getTitle_recipe() %>
                        </div>
