...
<html lang="en">
    ...
    <head>
        ...
        <title>Sản phẩm cho chim cảnh</title>
        ...
        <div class="container-fluid py-5">
            <div class="container">
                <div class="border-start border-5 border-primary ps-5 mb-5" style="max-width: 600px;">
                    ...
                    <h1 class="display-5 text-uppercase mb-0" style="font-size: 30px">Sản phẩm cho chim cảnh</h1>
                </div>
                <div class="col-xl-12">
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination pagination-lg m-0">
                        ...
                        <li class="page-item <% if (indexPage == 1) { %>disabled<% } %>">
                            <a class="page-link rounded-0" href="MainController?action=productpage&index=<%= indexPage - 1%>" aria-label="Previous">
                        ...
                        %>
                        <li class="page-item"><a class="page-link" href="MainController?action=productpage&index=<%= i%>"><%= i%></a></li>
                            <%
                        ...
                        <li class="page-item <% if (indexPage == pageNumber) { %>disabled<% } %>">
                            <a class="page-link rounded-0" href="MainController?action=productpage&index=<%= indexPage + 1%>" aria-label="Next">
